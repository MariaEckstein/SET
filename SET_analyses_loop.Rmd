...
gg_ppg_ACC_cont = ggplot(subjwise_perf_set_g, aes(ppg_cont, 100 * (1 - ACC), color = span)) +
  ...
  facet_grid(~ set) +
  theme_bw()
gg_ppg_RT_cont = gg_ppg_ACC_cont + aes(y = RT) + labs(y = "Respone time (msec)")
...
gg_ppg_ACC = ggplot(subjwise_perf_set_g, aes(span, 100 * (1 - ACC), color = ppg)) +
  stat_summary(fun.data = mean_se, geom = "pointrange") +
  scale_color_manual(values = bw_colors) +
  labs(x = "", y = "Error rate (%)", color = "") +
  facet_grid(~ set) +
  theme_bw()
gg_ppg_RT = gg_ppg_ACC + aes(y = RT) + labs(y = "Respone time (msec)")
...
if (ggsave_figures) {
  ...
  plot(gg_ppg_ACC)
  ggsave(plot = gg_ppg_ACC, paste(figure_dir, "/Figure8_ACC.png", sep = ""), width = 6, height = 3.5)
  plot(gg_ppg_RT)
  ggsave(plot = gg_ppg_RT, paste(figure_dir, "/Figure8_RT.png", sep = ""), width = 6, height = 3.5)
  plot(gg_ppg_IEPD)
  ggsave(plot = gg_ppg_IEPD, paste(figure_dir, "/Figure8_IEPD.png", sep = ""), width = 6, height = 3.5)
  plot(gg_ppg_dprime)
  ggsave(plot = gg_ppg_dprime, paste(figure_dir, "/Figure8_dprime.png", sep = ""), width = 6, height = 3.5)
  plot(gg_ppg_qu)
