...
# Get median RTs
median(pupildat_SET_ACC1_good$SET_RT)
median(subset(pupildat_SET_ACC1_good, RT_group == "fast")$SET_RT)
median(subset(pupildat_SET_ACC1_good, RT_group == "slow")$SET_RT)
