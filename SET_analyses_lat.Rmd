...
if (data_year == "2016") {
  ...
  ## Add mouse_hand column
  allfiles$mouse_hand = "L"
  allfiles$mouse_hand[allfiles$Subject %% 2 == 0 & allfiles$block %% 2 == 0] = "R"  #if Subject id is even, even blocks should be "R"
  allfiles$mouse_hand[allfiles$Subject %% 2 == 1 & allfiles$block %% 2 == 1] = "R"  #if Subject id is odd, odd blocks should be "R"
